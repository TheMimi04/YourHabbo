...
<html lang="en">
    <head>
		...
		<title>Tickets - <?= $Controller->Settings('name'); ?></title>
    ...
    <body data-ma-theme="blue">
        <main class="main">
            ...
            <section class="content">
				...
				<div class="row">
					<?php if($_GET['id']) { $_SESSION['idte'] = $Controller->GetID('id'); ?>
					<div class="col-md-12">
						<?= $StingCMS->ADMLookTicket(); ?>
					</div>
					<?php } else { ?>
					<div class="col-md-12">
						<div class="card">
		...
		<script src="js/adm/ticket.js"></script>
    </body>
</html>